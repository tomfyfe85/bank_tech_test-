...
This is written in JavaScript, to be run on node and tested with jest so please see below for installation guidence if needed so please use node to run. 

Javascript install in command line:
